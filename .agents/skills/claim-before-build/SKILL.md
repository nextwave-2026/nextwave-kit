...
- If it is clear, append a dated claim to `STATUS.md` before starting work, including the unit, operator, and branch. Commit this coordination update straight to `main`, separately from code.
